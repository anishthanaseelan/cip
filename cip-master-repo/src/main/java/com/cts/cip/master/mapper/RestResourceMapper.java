...
public class RestResourceMapper {
	...
	public static StatusResponse buildSuccessResponse(String resourceName,String value,String type) {
	...
	public static StatusResponse buildErrorResponse(String errorMessage,String code) {
		StatusResponse statusResponse = new StatusResponse();
