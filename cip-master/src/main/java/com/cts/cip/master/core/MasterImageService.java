 ...
 *
 */
public interface MasterImageService {

	ImageDetailsResponse uploadImage(ImageDetailsRequest imageDetailRequest, String resourceName, Integer resourceId)
			throws ImageValidationException, ResourceNotAvailableException, ImageUploadException;
