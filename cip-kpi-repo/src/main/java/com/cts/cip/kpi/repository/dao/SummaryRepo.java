...
public interface SummaryRepo {
	...
	public List<ShipmentSummary> getSummaryList(GetKpiSummaryRequest request, ReportType byHour);	
	public List<ShipmentSummary> getPendingSummaryList(GetKpiSummaryRequest request, ReportType pendingByHour);
