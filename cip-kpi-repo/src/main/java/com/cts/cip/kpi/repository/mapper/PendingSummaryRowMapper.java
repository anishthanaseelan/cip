...
public class PendingSummaryRowMapper implements RowMapper<ShipmentSummary> {
	@Override
	public ShipmentSummary mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		shipmentSummary.setPendingLoadCount(rs.getLong("pending_load"));
		shipmentSummary.setPendingManifestCount(rs.getLong("pending_manifest"));
