...
public class ZPLDocumentGeneratorTest {
	...
	public void testGenerate() throws SystemFailure{
		...
		Assert.assertTrue(zplEngine!= null);
		
		zplEngine.generate(streamSource.getSystemId(), "src/test/resources/shippinglabel/sampleZPLLabel.xsl", "zpl.buf");
	}
}
