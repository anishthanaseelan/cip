...
import com.cts.cip.common.exceptions.DateFormatException;
...
public interface ShippingListService {	
	...
	Integer getgetShippingUnitCount();

	List<ShipmentLoadInfo> getShipUnitList(SearchCriteria searchCriteria) throws CriteriaValidationException;
